...
* **macOS arm64**: <a href="https://github.com/@@ASSETS_REPOSITORY@@/releases/download/@@VERSION_WITHOUT_PATCH_SUFFIX@@@@QUALITY@@/@@APP_NAME@@-darwin-arm64-@@VERSION_WITHOUT_PATCH_SUFFIX@@@@QUALITY@@.zip">@@APP_NAME@@-darwin-arm64-@@VERSION_WITHOUT_PATCH_SUFFIX@@@@QUALITY@@.zip</a>
* **macOS x64**: <a href="https://github.com/@@ASSETS_REPOSITORY@@/releases/download/@@VERSION_WITHOUT_PATCH_SUFFIX@@@@QUALITY@@/@@APP_NAME@@-darwin-x64-@@VERSION_WITHOUT_PATCH_SUFFIX@@@@QUALITY@@.zip">@@APP_NAME@@-darwin-x64-@@VERSION_WITHOUT_PATCH_SUFFIX@@@@QUALITY@@.zip</a>
